...
class likedme extends StatelessWidget {
  List<User> userdata = [];
  static const routeName = '/liked_me';
                    ...
                    child: BlocBuilder<UserBloc, UserState>(
                      builder: (_, state) {
                        ...
                        if (state is UserLoadSuccess) {
                          ...
                          return Expanded(
                            child: list_widget(users: snapshot.data),
                          );
                        }
...
Future<List<User>> getLikers(String email) async {
  final response = await http.get(Uri.parse('$_baseUrl/api/like/${email}'));
